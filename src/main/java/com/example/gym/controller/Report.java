...
public class Report {
    ...
    @FXML
    private DatePicker txtfeomdate;
    ...
    void btnsaveonaction(ActionEvent event) {
            ...
            String fromdate = String.valueOf(txtfeomdate.getValue());
            String todate = String.valueOf(txttodate.getValue());
            String income = txtreport.getText();
    ...
    private void clearFields() {
        txtfeomdate.setValue(LocalDate.parse(""));
        txttodate.setValue(LocalDate.parse(""));
        txtreport.setText("");

    }

    public void btnviewonaction(ActionEvent actionEvent) throws IOException {
        AnchorPane anchorPane = FXMLLoader.load(getClass().getResource("/view/ViewReport.fxml"));
        Scene scene = new Scene(anchorPane);
        Stage stage = (Stage) root.getScene().getWindow();
        stage.setScene(scene);
        stage.setTitle("Equipment Page");
